...
void CLocatorAPI::setup_fs_path(pcstr fs_name)
{
    ...
    else
    {
        ...
        else
        {
             ...
             * I propose adding shaders from <CMAKE_INSTALL_FULL_DATAROOTDIR>/opensxray/gamedata/shaders so that we remove unnecessary questions from users who want to start
